...
module.exports = function (app) {
  ...
  app.post('/appendFile', function(req, res) {
    ...
    /* AGGIUNGERE IL CONTROLLO PER CREARE LA CARTELLA QUESTION SE NON ESISTE ALTRIMENTI NON FUNZIONA NULLA */
    if(req.session.professor){
