...
module.exports = function (app) {
  ...
  app.post('/createCopy',function(req, res){
    if (req.session.professor) {
      ...
      while(fs.existsSync(pathFileJson)) {
        pathFileJson = './views/exams/'+nameFile+"_c"+i+".json";
  ...
  app.post('/createFileJson', function(req, res) {
    if (req.session.professor) {
      ...
      var dirResultToday = './views/result/'+currentDateExam;
      ...
      /*else{
        ...
        numberExam = numberlastDir + 1;
        currentDateExam = nameExam.slice(-10)+"_P"+numberExam;
        var newDirResultToday = './views/result/'+currentDateExam;
