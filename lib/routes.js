...
module.exports = function (app) {
  ...
  app.post('/uploadFileCustom', function(req, res){
    ...
    var tmp_path, target_path;
      ...
      console.log(req.files.fileUploaded.size);

      if (req.files.fileUploaded.name !== '' && req.files.fileUploaded.size !== 0){
        // get the temporary location of the file
        tmp_path = req.files.fileUploaded.path;
    ...
    //TODO change into a post request
    app.get('/setClockAula', binHandler.setClockClassroom);
