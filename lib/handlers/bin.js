...
var mocha = new Mocha();
mocha.addFile("test/myjsbin/testExam2");

var pathModule = require('path');
var moment = require('moment');
var MINUTE2MILLIS = 60000;
//mocha.removeFile("test/myjsbin/testExam");
...
//                   console.log(response);
       ...
       function parseUrl(url){
           ...
           var examUrl = statik+"/"+exams[examIndex].url+"/"+exams[examIndex].revision+"/watch";
           exams[examIndex].examUrl = "<a href='"+examUrl+"'>"+examUrl+"</a>";
       }
...
//           $("html").append("\n<script>\n  var y = $('body').length; var x = 11; \n $(document).ready(function(){ \n x= $('p').length; \n }); function zeta() { return 3;} </script>");
           ...
           window.addEventListener('load',  function(){
               ...
               mocha.run(function(){
                   ...
                   delete require.cache[tmpPath+'test'+pathModule.sep+'myjsbin'+pathModule.sep+'testExam2.js'];
//                   delete require.cache['c:\\Users\\Trappola\\WebstormProjects\\myJsbin\\test\\myjsbin\\testExam2.js'];
       ...
       function makeVote(){
           ...
           var vote = 30;
           vote -= exams[examIndex].error_Html * weightStandardHtml;
           vote -= exams[examIndex].error_Css * weightStandardCss;
           vote -= exams[examIndex].error_Javascript * weightStandardJavascript;
           vote -= exams[examIndex].failure_Mocha * weightMochaFailure;
