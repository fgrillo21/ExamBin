...
module.exports = Observable.extend({
  ...
  getBin: function (req, res, next) {
      console.log("Ohi ohi ohi siamo in getBin di bin.js");
    this.render(req, res, req.bin);
  },
   getAllSandbox: function (req, res, next){
        console.log("EHILà SIAMO IN GET ALL SANDBOX WOWOWOWO");
        var _this  = this;
        _this.models.bin.getAllSansbox("ciao", function (err, result) {
            if (err) {
                return next(err);
            }
