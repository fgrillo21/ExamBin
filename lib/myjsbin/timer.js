...
var status = "notest";
var timeout = 6000; //number of millisecond at the end of the exam
var url = null; // set in base of the machine where I start myJsbin
var startExam = null;
var finishExam = null;
var durationTest = 7200000; //in millis of course ==> 10 minute default
var durationOverTime = 0;
var MILLIS_TO_SET_START = 5000;
var MILLIS_TO_SET_OVERTIME = 10000; //when missing 15 second to official end of the test
