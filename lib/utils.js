...
module.exports = {
  ...
  shortcode: function (studentData, id) {
    ...
    return word; */
      ...
      var word;
      if (studentData) {
          word = moment().format('YYYY-MM-DD') + "_" + studentData.name + "_" + studentData.surname + "_" + studentData.matricola + "_" + studentData.postazione + "__"+ index_autoincrement;
      } else {
  ...
  binUrlLength: function (req) {
    ...
    setAutoIncrementIndex: function (startIndex) {
        if (startIndex) {
            index_autoincrement = startIndex ;
        } else {
