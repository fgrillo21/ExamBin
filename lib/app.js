...
app.connect = function (callback) {
  ...
  app.configure(function () {
    ...
    app.use(middleware.csrf({ ignore: ['/','/createCopy','/getValueFileJson','/appendFile','/professor/uploadExamTextFile','/createFileJson','/clearQuestionFile','/correction/setWeightValidation','/correction/uploadFileCustom','/setClockAula','/deliveryExam','/setDataClockAula', '/setQuestionNumber','/uploadFileCustom','/confirmStudent',/^\/api\//, /^\/hooks\//, /^\/subscribe\//] }));
