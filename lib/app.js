...
app.connect = function (callback) {
  ...
  app.configure(function () {
    ...
    app.use(middleware.csrf({ ignore: ['/','/setIdJsbinChecked','/loadValueToJsbin','/loadQuestion','/list','/setDataOverTimeOne','/setDataOverTimeFive','/createCopy','/setupLoginStudent','/getValueFileJson','/appendFile','/professor/uploadExamTextFile','/createFileJson','/clearQuestionFile','/correction/setWeightValidation','/correction/uploadFileCustom','/setClockAula','/deliveryExam','/setDataClockAula','/uploadFileCustom','/confirmStudent',/^\/api\//, /^\/hooks\//, /^\/subscribe\//] }));
