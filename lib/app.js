...
app.connect = function (callback) {
  ...
  app.configure(function () {
    ...
    app.use(middleware.csrf({ ignore: ['/','/professor/uploadExamTextFile','/clearDefaultFile','/correction/setWeightValidation','/correction/uploadFileCustom','/setClockAula','/deliveryExam','/setDataClockAula','/uploadFileCustom','/confirmStudent',/^\/api\//, /^\/hooks\//, /^\/subscribe\//] }));
