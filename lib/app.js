...
app.connect = function (callback) {
  ...
  app.configure(function () {
    ...
    app.use(middleware.csrf({ ignore: ['/','/remove','/cloneDivQuestion','/appendFile','/professor/uploadExamTextFile','/createFileJson','/clearQuestionFile','/clearDefaultFile','/correction/setWeightValidation','/correction/uploadFileCustom','/setClockAula','/deliveryExam','/setDataClockAula', '/setQuestionNumber','/uploadFileCustom','/confirmStudent',/^\/api\//, /^\/hooks\//, /^\/subscribe\//] }));
